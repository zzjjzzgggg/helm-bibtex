...
(ivy-bibtex-ivify-action bibtex-completion-open-pdf-with-xreader ivy-bibtex-open-pdf-with-xreader)
(ivy-bibtex-ivify-action bibtex-completion-open-pdf-with-zathura ivy-bibtex-open-pdf-with-zathura)
...
(ivy-set-actions
 'ivy-bibtex
 '(("x" ivy-bibtex-open-pdf-with-xreader "Open in xreader" ivy-bibtex-open-pdf-with-xreader)
   ("z" ivy-bibtex-open-pdf-with-zathura "Open in zathura" ivy-bibtex-open-pdf-with-zathura)
